...
async function markCompleteGroceryList(){
    ...
    try{
        const response = await fetch(`grocery-list-demo/markCompleteGroceryList`, {
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
                'idFromJS': id
...
async function markIncompleteGroceryList(){
    ...
    try{
        const response = await fetch(`grocery-list-demo/markIncompleteGroceryList`, {
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
                'idFromJS': id
...
async function deleteItemGroceryList(){
    ...
    try{
        const response = await fetch('grocery-list-demo/deleteItemGroceryList', {
            method: 'delete',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
              'idFromJS': id
